...
def set_budget(amount): # function receives two parameters budget and amount
    if amount <= 0: # if the amount is equal or smaller than zero 
        raise ValueError("Budget must be positive")  # # raise error if amount is invalid
